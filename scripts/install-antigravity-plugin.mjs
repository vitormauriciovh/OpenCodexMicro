...
const source = resolve(
  "integration/com.ulanzi.antigravity.ulanziPlugin"
);
...
if (manifest.UUID !== "com.ulanzi.ulanzistudio.antigravity") {
...
console.log(`Ulanzi Studio Antigravity plugin installed at: ${destination}`);
console.log("Restart Ulanzi Studio to load the updated Antigravity plugin.");
