...
const source = resolve(
  "integration/com.ulanzi.spotify.ulanziPlugin"
);
...
if (manifest.UUID !== "com.ulanzi.ulanzistudio.spotify") {
...
console.log(`Ulanzi Studio Spotify plugin installed at: ${destination}`);
console.log("Restart Ulanzi Studio to load the updated Spotify plugin.");
